...
//Crear un promise 
const obtenerCriptomonedas = criptomodenas => new Promise(resolve =>{
    resolve(criptomodenas);
});
...
function mostrarCotizacionHTML(cotizacion){
    ...
    ultimasHoras.innerHTML = `<p>Variacion últimas 24 horas: <span>${CHANGEPCT24HOUR}%</span></p>`;
