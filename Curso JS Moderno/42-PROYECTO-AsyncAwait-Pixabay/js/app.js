...
async function buscarImagen(){
    ...
    const key = '24723939-17fb2a63c3e1c3291b1b77d9b';
    ...
    fetch(url)
        ...
        .then(respuesta => {
            totalPaginas = calcularPaginar(respuesta.totalHits);
            mostrarImagen(respuesta.hits);
        });
    */
    ...
    try {
        ...
        totalPaginas = calcularPaginar(resultado.totalHits);
...
function calcularPaginar(total){
